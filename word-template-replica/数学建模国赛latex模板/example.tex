...
今年的格式变化如下：
\begin{enumerate}
\item 论文提交明确不需要承诺书内容，模版进行了删减，要求如下：

\centerline{\includegraphics[width=11cm]{upload}}

\item 字体设置进行了删减，保证 overleaf 等平台可以直接使用。
...
\url{https://www.latexstudio.net} 陆续推出了更优质的资源，欢迎学习 。欢迎大家到QQ群里沟通交流：91940767/200392395。问答区交流 \LaTeX{}技术：\url{https://ask.latexstudio.net}，有问题就来这里，与大神零距离。
